...
def plot_data(real_user_data, pe_user_data, user_names):
    """
    Plot line graphs comparing real data with PowerEye data for each user.

    Args:
        real_user_data (list): The data collected from the smart plug cloud.
        pe_user_data (list): The data collected using the PowerEye Tracker Server.
        user_names (list): The names of the users for whom the data is being plotted.
    """
